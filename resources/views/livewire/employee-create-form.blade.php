        ...
        <div class="mb-3">
            <div class="w-100">
                ...
                <div class="mb-3">
                    ...
                    <x-form-input id="phone{{ $i }}" type="number" name="phone{{ $i }}" wire:model.defer="employees.{{ $i }}.phone"
                        placeholder="Format: 08**" />
                    <x-form-error key="employees.{{ $i }}.phone" />
                </div>
                <div class="mb-3">
                    <x-form-label id="password{{ $i }}"
                        label='Password Anggota {{ $i + 1 }} (password otomatis: "123" jika tidak diisi)' required="false" />
                ...
                <div class="mb-3">
                    <x-form-label id="position_id{{ $i }}" label='Jabatan / Posisi Anggota {{ $i + 1 }}' />
