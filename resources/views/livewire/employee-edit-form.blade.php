            ...
            <div class="w-100">
                <div class="mb-3">
                    <x-form-label id="name{{ $employee['id'] }}"
                        label="Nama Anggota {{ $loop->iteration }} (ID: {{ $employee['id'] }})" />
                ...
                <div class="mb-3">
                    <x-form-label id="email{{ $employee['id'] }}" label='Email Anggota {{ $loop->iteration }}' />
                ...
                <div class="mb-3">
                    ...
                    <x-form-input id="phone{{ $employee['id'] }}" type="number" name="phone{{ $employee['id'] }}"
                ...
                <div class="mb-3">
                    <x-form-label id="position_id{{ $employee['id'] }}"
                        label='Jabatan / Posisi Anggota {{ $loop->iteration }}' />
